...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Delflow — Quick, safe, reliable delivery" },
      ...
      { property: "og:title", content: "Delflow — Quick, safe, reliable delivery" },
      ...
      { name: "twitter:title", content: "Delflow — Quick, safe, reliable delivery" },
